...
Check out the live demo: https://movie-reccomend-system.herokuapp.com/
...
If you're getting invalid request error in your application, kindly press "ctrl + f5" several times (which clears the content of the browser cache).
